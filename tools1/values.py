...
Department[1] = {'deptname':'Computer Science','deptlocation':'Near Main Building','deptkey':'copmsci'}
Department[2] = {'deptname':'Chemistry','deptlocation':'Opposite Aniket Canteen','deptkey':'chem'}
Department[3] = {'deptname':'Mathematics','deptlocation':'Opp of Health Center','deptkey':'math'}
...
Faculty[1] ={'fusername':'patilsir','passwd':'p','facultyname':'PATIL SIR','facultymobileno':837800789,'facultyaddress':'Pune','facultyemail':'patil@gmail.com','facultysalary':10000, 'courseid': 1}
Faculty[2] ={'fusername':'dmksir','passwd':'dmksir','facultyname':'DMK SIR','facultymobileno':703029804,'facultyaddress':'Solapur','facultyemail':'dmk@gmail.com','facultysalary':10000, 'courseid': 2}
Faculty[3] ={'fusername':'aksir','passwd':'akrsir','facultyname':'AKR SIR','facultymobileno':848583310,'facultyaddress':'Banglore','facultyemail':'akr@gmail.com','facultysalary':10000, 'courseid': 1}
Faculty[4] ={'fusername':'jyotimam','passwd':'j','facultyname':'JYOTI MAM','facultymobileno':1234567899,'facultyaddress':'Jalgaon','facultyemail':'jy@gmail.com','facultysalary':10000, 'courseid': 2}
...
print("Total time took: " + str(endTime - startTime) + " seconds")