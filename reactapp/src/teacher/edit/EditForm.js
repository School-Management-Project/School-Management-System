...
class EditForm extends Component {
  ...
  bindData(e) {
    ...
    var finalurl = `http://127.0.0.1:8000/faculty/` + self.state.userName + `/`;
    ...
    axios({
      ...
      .then(function (response) {
        ...
        self.setState({ 'name': response.data['facultyname'] })
        self.setState({ 'address': response.data['facultyaddress'] })
        self.setState({ 'mobileNo': response.data['facultymobileno'] })
        self.setState({ 'email': response.data['facultyemail'] })
...
//       var url= `http://127.0.0.1:8000/facultyEdit/`
